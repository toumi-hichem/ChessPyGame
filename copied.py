...
bp = Piece('b', 'p', 'pawn_b.png')
wp = Piece('w', 'p', 'pawn_w.png')
bk = Piece('b', 'k', 'king_b.png')
wk = Piece('w', 'k', 'king_w.png')
br = Piece('b', 'r', 'rook_b.png')
wr = Piece('w', 'r', 'rook_w.png')
bb = Piece('b', 'b', 'bishop_b.png')
wb = Piece('w', 'b', 'bishop_w.png')
bq = Piece('b', 'q', 'queen_b.png')
wq = Piece('w', 'q', 'queen_w.png')
bkn = Piece('b', 'kn', 'knight_b.png')
wkn = Piece('w', 'kn', 'knight_w.png')
